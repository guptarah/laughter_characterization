function [bigram_all_feats] = get_code_vectors_around_laugh_v2(win_size)

% In this version we get features for these 5 classes
% 1: no laughter
...
csvwrite('all_feats.v2',bigram_all_feats);
